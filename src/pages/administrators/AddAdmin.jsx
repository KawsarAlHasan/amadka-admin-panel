...
const AddAdmin = () => {
  ...
  return (
    <>
      <Button type="primary" className="mb-2 custom-primary-btn" onClick={showModal}>
      ...
      >
        <Form layout="vertical" onFinish={handleFinish}>
          ...
          <Form.Item>
            <Button type="primary" htmlType="submit" className="custom-primary-btn" loading={loading} block>
              Create Admin
            </Button>
          </Form.Item>
        </Form>
